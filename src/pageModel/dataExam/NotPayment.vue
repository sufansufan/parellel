<template>
    <div class="table">
        <el-table :data="data" size="mini" stripe style="width: 100% ;margin-top:10px;" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="refund_reason" label="申请退款原因"></el-table-column>
                    ...
                    <div v-if="addTeamLayer" class="transition-box">
                        ...
                        <el-form :model="changeForm2"
                            ...
                            <el-row>
                                ...
                                <el-col :span="12">
                                    <el-form-item label="实际退款金额" prop="real_refund_amount" disabled>
                                        {{changeForm2.real_refund_amount}}
                                    </el-form-item>
                                </el-col>
                                <el-col :span="12">
                                ...
                                <el-col style="padding-top: 20px;text-align: center">
                                    <el-button type="primary" size="mini" icon="delete" class="handle-del mr10" @click="Qualified">审核通过</el-button>
                                    <el-button size="mini" type="primary" @click="noQualified">审核不通过</el-button>
                                </el-col>
                            </el-row>
                        </el-form>
                        <!--审核是否通过按钮-->
    ...
    export default {
        ...
        methods: {
            ...
            getData() {
                ...
                console.log("查询异常状态的父母信息", objData);
                this.$axios.post(this.GlobalVal.httpLink.queryRefundRecordByStatus, JSON.stringify(objData)).then(
                    res => {
            ...
            Qualified() {
                ...
                let objData = {
                    ...
                    refundRecord: {
                        ...
                        real_refund_amount: this.changeForm2.real_refund_amount,//实际退款金额(携带原有数据)
                ...
                this.$prompt('请输入不通过理由', '提示', {
                    ...
                    let objData = {
                        ...
                        refundRecord: {
                            id: this.changeForm2.id,
                            refund_status: "02001",
                            refund_remark: this.changeForm2.refund_remark,
                            audit_remark: value,
                            student_id: this.changeForm2.student_id,//学生id(携带原有数据)
                            student_name: this.changeForm2.student_name,//学生姓名(携带原有数据)
                            class_id: this.changeForm2.class_id,//班级id(携带原有数据)
