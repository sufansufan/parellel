...
<template>
  <div class="class-query table2">
    <el-table size="mini" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="class_name" width="250" fixed label="班级名称"></el-table-column>
                  ...
                  <el-row>
                    <el-col :span="7">
                      <el-form-item label="姓名" prop="bankCardPayee">
                        <el-input type="text" placeholder="请输入姓名" v-model="ruleForm.bankCardPayee">
                        </el-input>
                      </el-form-item>
                    </el-col>
                    <el-col :span="5">
...
export default {
  ...
  watch: {
    ...
    refundTimes: function() {
      ...
      if (
        ...
        this.classRefundAmount = this.getRefundInfoRes.signupOrder.real_payment.toFixed(
          2
        );
      }
  ...
  methods: {
    ...
    submitMoneyForm(ruleForm, qx = false) {
      ...
      if (this.classRefundAmount < 0) {
        this.$message.error("退费总额不正确！");
        return;
      }
      this.$refs[ruleForm].validate(valid => {
        if (valid) {
          ...
          let objData = {
            ...
            bankName: this.ruleForm.bankName, //银行名称
            alipayAcount: "", //支付宝帐号
            wechatAcount: "", //微信帐号
