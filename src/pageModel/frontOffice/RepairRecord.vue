...
<template>
    <div class="class-query table2">
        <el-table size="mini" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="waiting_index" label="候补序号" fixed></el-table-column>
            <el-table-column prop="campus_name" label="校区" fixed></el-table-column>
            <el-table-column prop="class_name" label="班级名称" width="260" fixed></el-table-column>
            <el-table-column prop="orderno" label="听课证编号" width="150"></el-table-column>
            ...
            <el-table-column prop="time_name" label="上课时段" width="95"></el-table-column>
            <el-table-column prop="class_name" label="教室" width="260"></el-table-column>
            <el-table-column prop="start_date" label="开课日期" width="95"></el-table-column>
            <el-table-column prop="end_date" label="结课日期" width="95"></el-table-column>
            ...
            <el-table-column prop="repair_number" label="候补序号"></el-table-column>
            <el-table-column prop="staff_name" label="操作人"></el-table-column>
            <el-table-column prop="signup_time" label="操作时间" width="95"></el-table-column>
            <el-table-column label="操作" width="200" fixed="right">
                <template slot-scope="scope">
                    <el-button size="mini" type="primary" @click="handleEdit(scope.$index, scope.row)">转入报名
                    </el-button>
