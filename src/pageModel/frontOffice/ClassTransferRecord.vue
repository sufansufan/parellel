...
<template>
    <div class="class-query table2">
        <el-table size="mini" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
            ...
            <el-table-column prop="oldstart_date" label="上课日期"></el-table-column>
            <el-table-column prop="oldtime_interval" label="上课时段" width="100"></el-table-column>
            <el-table-column prop="already_time" label="已上课次"></el-table-column>
            <el-table-column prop="newclass_name" label="转入班级名称" width="250"></el-table-column>
            <el-table-column prop="newcampus_name" label="所属校区"></el-table-column>
            <el-table-column prop="newstart_date" label="上课日期" width="100"></el-table-column>
            ...
            <el-table-column prop="turn_class_time" label="操作时间"></el-table-column>
        </el-table>
  ...
  computed: {
    ...
    data() {
      ...
      return self.dataList.filter(function(d) {
        ...
        d.already_time = d.oldsequence - 1;
        d.oldstart_date = self.Util.TimeCycle(
          new Date(d.oldstart_date).getTime(),
          "ymd"
        );
        d.newstart_date = self.Util.TimeCycle(
          new Date(d.newstart_date).getTime(),
          "ymd"
        );
        return d;
      });
