...
<template>
  <div class="class-query table2">
    <el-table size="mini" :data="data" border style="width: 100%" ref="multipleTable" @selection-change="handleSelectionChange">
      ...
      <el-table-column prop="campus_name" label="发起时间"></el-table-column>
      ...
      <el-table-column label="已上课次">
        <template slot-scope="scope">
          {{scope.row.buy_times - scope.row.refund_times}}
        </template>
      </el-table-column>
      <el-table-column prop="refund_times" label="剩余课次"></el-table-column>
      <el-table-column prop="total_price" label="报名金额"></el-table-column>
      <el-table-column prop="end_date" label="实付金额"></el-table-column>
      <el-table-column prop="single_price" label="课次退费"></el-table-column>
      <el-table-column prop="other_refund_amount" label="额外退费"></el-table-column>
      <el-table-column prop="total_price" label="退费总金额"></el-table-column>
      <el-table-column prop="staff_name" label="状态"></el-table-column>
      <el-table-column prop="staff_name" label="业务流水号"></el-table-column>
      <el-table-column prop="staff_name" label="发起人/审核人/打款人"></el-table-column>
      <el-table-column label="退费过程" width="200">
        <template slot-scope="scope">
          <!-- <el-button size="mini" type="primary"
                               @click="handleEdit(scope.$index, scope.row)">详情
                    </el-button>-->
          <el-button size="mini" type="primary" @click="printEdit(scope.$index, scope.row)">打印退款单
          </el-button>
        </template>
      </el-table-column>
    </el-table>
                ...
                <div class="financeLeft">
                  <div class="center">
                    <ul>
                      <li>
                        <i>学院姓名</i>
                        <p class="breadth_1">苏凡2</p>
                      </li>
                      <li>
                        <i>联系电话</i>
                        <p class="breadth_2">18709200196</p>
                      </li>
                      <li>
                        <i>所属小区</i>
                        <p class="breadth_3">所属校区 总部/华中大区/郑州/康桥校区</p>
                      </li>
                      <li>
                        <i>操作人</i>
                        <p class="breadth_1">苏凡</p>
                      </li>
                      <li>
                        <i>操作日期</i>
                        <p class="breadth_2">2018/1/25</p>
                      </li>
                      <li>
                        <i>退费原因</i>
                        <p class="breadth_3">不想念了</p>
                      </li>
                    </ul>
                    ...
                    <ul>
                      <li>
                        <i>退费方式</i>
                        <p class="breadth_1">网银转账</p>
                      </li>
                      <li>
                        <i>流水单号</i>
                        <p class="breadth_4">201801025285259</p>
                      </li>
                      <li>
                        <i class="breadth_2" style="font-weight: 700;">退费金额合计</i>
                        <p class="breadth_4" style="font-weight: 700;">￥5700</p>
                      </li>
                      <li>
                        <i>操作人</i>
                        <p class="breadth_1">苏凡</p>
                      ...
                      <li>
                        <i>银行卡号</i>
                        <p class="breadth_2">201801025285259</p>
                      </li>
        ...
        .then(
          res => {
            if (res.data.code === "10000") {
              ...
              console.log(res.data.studentOrders);
            } else {
              console.error(res);
              self.$message({
                type: "error",
